...
public class BranchDAO implements IBranch {
    ...
    public Branch get(Long id) {
        ...
        try {
            ...
            if(rs.next())
            {
                ...
                branch.setIdBank(rs.getLong("banks_id_bank"));
                branch.setIdAddress(rs.getLong("Addresses_id"));
                return branch;
            }
    ...
    public Branch save(Branch branch) {
        ...
        try {
            ...
            preparedStatement.setLong(2,branch.getIdBank());
            preparedStatement.setLong(3,branch.getIdAddress());
